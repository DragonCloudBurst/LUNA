...
namespace LUNA
{
    public partial class Form1 : Form
    {
        ...
        private void lightMode_Click(object sender, EventArgs e)
        {
            ...
            render.BackColor = Color.LightCyan;
            lightMode.BackColor = Color.LightCyan;
            darkMode.BackColor = Color.LightCyan;
        ...
        private void darkMode_Click(object sender, EventArgs e)
        {
            ...
            render.BackColor = Color.RoyalBlue;
            lightMode.BackColor = Color.RoyalBlue;
            darkMode.BackColor = Color.RoyalBlue;
